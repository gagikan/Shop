<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:37:"./template/pc/rainbow/user\index.html";i:1509957169;s:38:"./template/pc/rainbow/user\header.html";i:1509957169;s:36:"./template/pc/rainbow/user\menu.html";i:1509957169;s:40:"./template/pc/rainbow/public\footer.html";i:1509957168;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
			    	...
			    	<div class="ri-menu fr">
			    		...
			    		<div class="order-list p">
			    			<div class="ddlb-ayh">
                                ...
                                $md5_key = md5("select * from `__PREFIX__order` where user_id = $user[user_id] and order_prom_type < 5 order by order_id desc limit 1");
                                $order_list = $sql_result_item = S("sql_".$md5_key);
                                if(empty($sql_result_item))
                                {                            
                                    $order_list = $sql_result_item = \think\Db::query("select * from `__PREFIX__order` where user_id = $user[user_id] and order_prom_type < 5 order by order_id desc limit 1"); 
