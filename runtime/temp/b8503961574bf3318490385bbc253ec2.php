<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:36:"./template/pc/rainbow/user\info.html";i:1509957169;s:38:"./template/pc/rainbow/user\header.html";i:1509957169;s:36:"./template/pc/rainbow/user\menu.html";i:1509957169;s:40:"./template/pc/rainbow/public\footer.html";i:1509957168;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
							...
							<div class="personerinfro">
								<form action="" method="post">
									...
									<ul class="name_jz">
										...
										<li><a href="javascript:void(0);"><input class="name_zjxs" type="text" name="nickname" id="nickname" value="<?php echo $user['nickname']; ?>" /></a></li>
									</ul>
									<!--<ul class="name_jz">-->
									...
									<ul class="hobby_jz">
										...
										<li class="infor_wi_ri">
											<div class="pcews">
												...
												<span class="<?php if($user[mobile_validated] == 0): ?>change_e<?php else: ?>change_p<?php endif; ?>"><a href="<?php echo U('Home/User/mobile_validate',array('type'=>'mobile','step'=>1)); ?>" style="cursor:pointer;"><?php if($user['mobile_validated'] == 0): ?>未绑定<?php else: ?>更换绑定<?php endif; ?></a></span>
												<span><i class="em_c"></i>邮箱</span>
												<span class="<?php if($user[email_validated] == 0): ?>change_e<?php else: ?>change_p<?php endif; ?>"><a href="<?php echo U('Home/User/email_validate',array('type'=>'email','step'=>1)); ?>" style="cursor:pointer;"><?php if($user['email_validated'] == 0): ?>未绑定<?php else: ?>更换绑定<?php endif; ?></a></span>
											</div>
											<div class="careful">
												<span class="fir_sen">注：修改密码、手机等信息到</span>
												<span class="co_blue"><a href="<?php echo U('Home/User/safety_settings'); ?>" style="cursor:pointer;">安全设置</a></span>
											</div>
											<div class="save_s">
