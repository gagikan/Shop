<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:45:"./template/pc/rainbow/user\goods_collect.html";i:1509957169;s:38:"./template/pc/rainbow/user\header.html";i:1509957169;s:36:"./template/pc/rainbow/user\menu.html";i:1509957169;s:40:"./template/pc/rainbow/public\footer.html";i:1509957168;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
				    		...
				    		<div class="sc_collect book-tit shop-listanadd">
								<?php if(is_array($lists) || $lists instanceof \think\Collection || $lists instanceof \think\Paginator): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
									<ul>
										...
										<li class="sx5">
											<div class="adhscar">
												<?php if($list['is_virtual'] == 1): ?>
													<a class="add_p_shop" href="<?php echo U('Home/Goods/goodsInfo',array('id'=>$list['goods_id'])); ?>">查看详情</a>
													<?php else: ?>
													<a class="add_p_shop" onclick="AjaxAddCart(<?php echo $list[goods_id]; ?>,1);">加入购物车</a>
												<?php endif; ?>
